 ...
 * @author soib1a20
 */
public class ActionsBuscarContrato {

    private PnlBuscarContrato frame;

    public ActionsBuscarContrato(PnlBuscarContrato frame) {
        this.frame = frame;
    }
    ...
    public void openEditForm(int idContrato) {
        ...
        try {
            ...
            Logger.getLogger(ActionsBuscarContrato.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
