...
public class Setmana1Tests {
    ...
    /**
     * Modifiqueu la classe RepositoriAlumnesMemoria per a que sigui un
     * compoment detectat per Spring
     */
    @Test
    ...
    /**
     * Modifiqueu la classe ServeiAlumnat per a que sigui un compoment detectat
     * per Spring
     */
    @Test
    ...
    /**
     * Implementau el metode ServeiAlumnat.matricula(id, nom), tal com trobareu
     * alla especificat
     */
    @Test
    ...
    /**
     * Modifiqueu la classe ServeiAlumnat per a que, just crear-se, inserti dos
     * alumnes al repositori: id = 1, nom = Antonia id = 2, nom = Joan
     */
    @Test
    ...
    /**
     * Construiu dins del package org.formacio.mvc un controlador que retorni el
     * número d'alumnes que hi ha al repositori quan es faci la peticio /alumnes
     *
     * El controlador ha de tenir una referencia a ServeiAlumnat (via
     * dependencia) El controlador NO pot tenir cap referencia a
     * RepositoriAlumnes
     *
     * pista: si el controlador ha de coneixer el numero d'alumnes i nomes pot
     * emprar ServeiAlumnat ... ... pot ser ServeiAlumnat necessitara un altre
     * metode.
     */
    @Test
